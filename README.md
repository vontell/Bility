...
The instructions below will walk through how to setup and start the testing server. You can build each part separately, or use the following command to start the required services (and skip steps #-#).

```
./some_script_here
```

## 1. Startup Test Server
